...
//    UIBarButtonItem.appearance().tintColor = UIColor(red: 201 / 255, green: 81 / 255, blue: 0.0, alpha: 1.0)
  ...
  func applicationWillTerminate(application: UIApplication) {
	...
	lazy var applicationDocumentsDirectory: NSURL = {
		// The directory the application uses to store the Core Data store file. This code uses a directory named "Swift.CodeData" in the application's documents Application Support directory.
